<x-guest-layout>
    <div class="min-h-screen flex items-center justify-center bg-cover bg-center" style="background-image: url('{{ asset('loginbackground.jpg') }}')">
        <div class="bg-white bg-opacity-20 backdrop-blur-lg rounded-lg p-4 shadow-lg max-w-md w-full">
            <x-authentication-card class="bg-transparent p-6 rounded-lg shadow-lg">
                <x-slot name="logo">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div>
                        <x-label for="email" value="{{ __('Email') }}" class="text-lilac" />
                    ...
                    <div class="mt-4">
                        <x-label for="password" value="{{ __('Password') }}" class="text-lilac" />
